...
from coder.model_config import MODEL_FALLBACKS, MODEL_MAX_OUTPUT_TOKENS, MODEL_TIMEOUT_SECONDS, ModelSpec
...
def fallback_llm() -> FallbackLLM:
    ...
    return FallbackLLM(model="quality-first-coder-fallback", attempts=attempts)
