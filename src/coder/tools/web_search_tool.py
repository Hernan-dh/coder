"""Optional web search for current programming documentation."""
...
class WebSearchInput(BaseModel):
    query: str = Field(..., description="A focused programming or documentation query.")


class WebSearchTool(BaseTool):
    name: str = "web_search"
    description: str = (
        "Search current web documentation, API references, and technical examples. "
        "Use it when local files and tests do not establish the answer."
    )
